...
# Interpreter reads left to right while Arabic reads right to left so I reshaped the text to make it in readable format without backward words or cut off letters
